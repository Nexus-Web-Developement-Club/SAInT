  ...
  <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex flex-col">
    ...
    <section className="w-full py-16 px-4 flex flex-col items-center justify-center bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-800 text-white shadow-lg">
      <img 
        ...
        alt="SAInT Logo" 
        className="w-24 h-24 rounded-2xl mb-6 shadow-xl border-4 border-white/30" 
      />
    ...
    <section className="w-full flex flex-col md:flex-row gap-8 px-8 py-16">
      <div className="flex-1 bg-white rounded-2xl shadow-xl p-8">
        ...
        <p className="text-lg text-gray-700 mb-4">
          SAInT (Student Association of Information Technology) is a vibrant college club dedicated to fostering innovation, collaboration, and growth among IT students. We organize workshops, seminars, hackathons, and social events to empower members with technical skills and leadership opportunities.
        </p>
      </div>
      ...
      <div className="flex-1 bg-white rounded-2xl shadow-xl p-8">
        ...
        <p className="text-md text-gray-600 mb-4">
          To create a supportive environment for learning, networking, and personal development while promoting teamwork, creativity, and excellence in Information Technology.
        </p>
        ...
        <ul className="list-disc list-inside text-gray-600 mb-2">
          ...
          <li>Connect with peers, alumni, and industry leaders</li>
    ...
    <section className="w-full py-12 px-8 flex flex-col items-center justify-center bg-gradient-to-r from-blue-600 via-indigo-700 to-purple-700 text-white">
      ...
      <p className="text-lg mb-6 text-center max-w-xl">
        Become a part of our dynamic community and unlock new opportunities in IT. Whether you're a beginner or an expert, SAInT welcomes you!
      </p>
